...
#define CDC_DATA_INTERFACE_NUM 3


#define CDC_CMD_MAX_PCAKET_SIZE 8
#define CDC_DATA_MAX_PACKET_SIZE 64
#define CDC_USB_BULK_TRIGGER_SIZE CDC_DATA_MAX_PACKET_SIZE
#define CDC_USB_COALESCE_CHARS 4U
#define CDC_USB_COALESCE_MIN_MS 1U
#define CDC_USB_COALESCE_MAX_MS 30U
